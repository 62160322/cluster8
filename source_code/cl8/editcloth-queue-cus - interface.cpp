	...
	int correctstatuswash(){
		...
		nodequeue *tmp = new nodequeue();
			tmp = obj_wash_cus->headq;
				...
				while(tmp != NULL){
					if(tel==tmp->telq&&tmp->optionq=="ww"||tmp->optionq=="WW"){	
						goto kip;
...
*/				
	...
	void showwashinganddryingmachine(){
		...
		cout<<"|----------|		|----------|		|----------|    	|----------|		|----------|	"<<endl;
				...
				ifstream infile2;
				infile2.open("macdry.txt", ios::in);
				
				while(getline(infile2, filein)){
				...
				ifstream infileq2;
				infileq2.open("macdryqueue.txt", ios::in);
				
				while(getline(infileq2, fileinq)){
...
class UI{
	...
	system ("CLS");
			...
			// add regular   
				...
				switch(chcloth){
					...
					case 2:{
						...
						int l=0;
						int k=1;
						nodequeue *tmpp = new nodequeue();
						tmpp = tam->headq;
						while(tmpp!=NULL){
							if(tmpp->telq==tel&&k==1){
								l=1;
								goto kip2;
							}
							k++;
				...
				case 3:{
			mach:		
			cout << "1. CheckMachine" << endl;
			cout << "2. EditMachine" << endl;
			cout << "3. Back" << endl;
			cout << " : ";
			cin >> choose;
			if(choose=="1"){
					wash->showwashinganddryingmachine();
					goto mach;
			}else if(choose=="2"){
				g:
		...
		case 2:{
			...
			cin  >> dry;
			pay->setRate(wash,dry);
			cout << "							|___________________________________________________________________________________________________|"<< endl;	
			cout << "							|                                                                                                   |"<< endl;	
			cout << setw(57) << std::right << "|" << setw(45) << std::right << "The Cost : " << setw(10) << std::right << pay->calculateRate() << setw(5) << std::right << "Bath"<< setw(40) << std::right << "|" << endl;	
			cout << "							|___________________________________________________________________________________________________|"<< endl;		
